...
{
    public partial class FrmAsignarMembresiaSocios : MaterialForm
    {
        ...
        public FrmAsignarMembresiaSocios(SocioAdmin socio)
        {
            ...
            {
                lblAbonoActual.Text = "Membresia actual: " + socio.nombreAbono.ToString();
            ...
            else
            {
                ...
                lblDiasDeAbonoPendiente.Visible = false;
            }
        ...
        public void asignarAbono()
        {
            try
            {
                ...
                {
                    MaterialMessageBox.Show($"Se le asigno la membresia {socio.nombreAbono} al socio {socio.nombre}, debe registrar el pago");
                }
                else
                {
